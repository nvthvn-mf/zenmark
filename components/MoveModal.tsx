...
const MoveModal: React.FC<MoveModalProps> = ({itemToMove, folders, onMove, onClose}) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
            <div
                className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[80vh] animate-in fade-in zoom-in duration-200">
                ...
                <div className="flex-1 overflow-y-auto p-2 space-y-1">
                    ...
                    >
                        <div
                            className="w-10 h-10 bg-slate-100 group-hover:bg-indigo-100 rounded-lg flex items-center justify-center">
                    ...
                    {availableFolders.length > 0 ? (
                        availableFolders.map(folder => (
                            ...
                            >
                                <div
                                    className="w-10 h-10 bg-white border border-slate-200 group-hover:border-indigo-200 rounded-lg flex items-center justify-center">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    {folder.parent_id &&
                                        <span className="text-[10px] text-slate-400">Sous-dossier</span>}
                                </div>
                            </button>
                        ))
                    ) : (
